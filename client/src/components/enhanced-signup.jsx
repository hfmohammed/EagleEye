          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-400 hover:cursor-pointer hover:text-slate-300 transition-colors"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:cursor-pointer hover:from-green-700 hover:to-emerald-700 text-white font-medium py-3 px-4 rounded-lg shadow-lg transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              disabled={isLoading}
            >
              {isLoading ? (
        ...
        <div className="px-8 pb-8 space-y-4">
          <div className="text-center text-sm text-slate-400">
            ...
            <button
              ...
              className="text-green-400 hover:cursor-pointer hover:text-green-300 font-medium hover:underline transition-colors"
            >
              Sign in
            </button>
          </div>
